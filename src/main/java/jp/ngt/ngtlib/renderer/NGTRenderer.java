...
public final class NGTRenderer {
    ...
    public static void renderFrame(double minX, double minY, double minZ, double width, double height, double depth, int color, int alpha) {
    ...
    public static void renderTileEntities(NGTWorld par1, float par8, int pass) {
        ...
        par1.getTileEntityList().forEach(tile -> renderTileEntityByRenderer(tile, tile.xCoord, tile.yCoord, tile.zCoord, par8, pass));
    }
    ...
    public static void renderEntities(NGTWorld par1, float par8, int pass) {
        par1.getEntityList().stream().filter(entity -> !entity.isDead).forEach(entity -> renderEntityByRenderer(entity, par8, pass));
    }
