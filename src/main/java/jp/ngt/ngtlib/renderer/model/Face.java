...
public class Face {
    ...
    public Face copy() {
        ...
        IntStream.range(0, this.vertices.length).forEachOrdered(i -> face.addVertex(i, this.vertices[i].copy(VecAccuracy.MEDIUM), this.textureCoordinates[i].copy()));
        return face;
    }
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            return IntStream.range(0, this.vertices.length).allMatch(i -> this.vertices[i].equals(face.vertices[i]));
        }
