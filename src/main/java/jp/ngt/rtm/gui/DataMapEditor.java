...
public class DataMapEditor extends JFrame {
    ...
    private void init() {
        ...
        for (Entry<String, DataEntry> entry : map.entrySet()) {
            ...
            IDataFilter filter = this.parentGui.selector.getModelSet().dataFormatter.getFilter(entry.getKey());
            if (filter != null) {
    ...
    public class DMEditorTable extends JTable {
        public DMEditorTable(Font font, int fontSize, String[][] rowData, String[] columnNames) {
            ...
            DataFormatter formatter = DataMapEditor.this.parentGui.selector.getModelSet().dataFormatter;
